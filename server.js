...
const[validationErrors,setValidationErrors]=useState({});const panelWidthOptions={single54:{'American Pleat':[{label:'Very High',value:22},{label:'High',value:24},{label:'Medium',value:26},{label:'Low',value:28}],'Ripple':[{label:'Very High',value:20},{label:'High',value:22}],'Rod Pocket':[{label:'Very High',value:20},{label:'High',value:22}],'Plain Classic':[{label:'Very High',value:36},{label:'High',value:40},{label:'Medium',value:44},{label:'Low',value:48}]},single48:{'American Pleat':[{label:'Very High',value:20},{label:'High',value:22},{label:'Medium',value:24},{label:'Low',value:26}],'Ripple':[{label:'Very High',value:18},{label:'High',value:20}],'Rod Pocket':[{label:'Very High',value:18},{label:'High',value:20}],'Plain Classic':[{label:'Very High',value:34},{label:'High',value:38},{label:'Medium',value:42},{label:'Low',value:46}]},double:{'American Pleat':[{label:'Very High',value:22},{label:'High',value:24},{label:'Medium',value:26},{label:'Low',value:28}],'Ripple':[{label:'Very High',value:20},{label:'High',value:22}],'Rod Pocket':[{label:'Very High',value:20},{label:'High',value:22}],'Plain Classic':[{label:'Very High',value:36},{label:'High',value:40},{label:'Medium',value:44},{label:'Low',value:48}]}};
