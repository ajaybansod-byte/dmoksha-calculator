...
const[subMode,setSubMode]=useState('54');const[inputs,setInputs]=useState({customerName:'',width:'',height:'',stitchStyle:'Plain Classic',panelWidth:48,pricePerMeter:''});
...
const[validationErrors,setValidationErrors]=useState({});const panelWidthOptions={single54:{'Plain Classic':[{label:'Very High',value:48},{label:'High',value:44},{label:'Medium',value:40},{label:'Low',value:36}],'American Pleat':[{label:'Very High',value:28},{label:'High',value:26},{label:'Medium',value:24},{label:'Low',value:22}],'Rod Pocket':[{label:'Very High',value:22},{label:'High',value:20}],'Ripple':[{label:'Very High',value:22},{label:'High',value:20}]},single48:{'Plain Classic':[{label:'Very High',value:46},{label:'High',value:42},{label:'Medium',value:38},{label:'Low',value:34}],'American Pleat':[{label:'Very High',value:26},{label:'High',value:24},{label:'Medium',value:22},{label:'Low',value:20}],'Rod Pocket':[{label:'Very High',value:20},{label:'High',value:18}],'Ripple':[{label:'Very High',value:20},{label:'High',value:18}]},double:{'Plain Classic':[{label:'Very High',value:48},{label:'High',value:44},{label:'Medium',value:40},{label:'Low',value:36}],'American Pleat':[{label:'Very High',value:28},{label:'High',value:26},{label:'Medium',value:24},{label:'Low',value:22}],'Rod Pocket':[{label:'Very High',value:22},{label:'High',value:20}],'Ripple':[{label:'Very High',value:22},{label:'High',value:20}]}};
const stitchStyleOptions=[{label:'Plain Classic',value:'Plain Classic',cost:200},{label:'American Pleat',value:'American Pleat',cost:250},{label:'Rod Pocket',value:'Rod Pocket',cost:300},{label:'Ripple',value:'Ripple',cost:350}];
...
const firstOption=panelWidthOptions[key]['Plain Classic'][0];setInputs(prev=>({...prev,stitchStyle:'Plain Classic',panelWidth:firstOption.value}));};
